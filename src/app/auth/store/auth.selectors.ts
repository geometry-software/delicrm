...
const labelRequested: string = AuthConstants.labelRequested
const labelClient: string = AuthConstants.labelClient
const labelEmployee: string = AuthConstants.labelEmployee
