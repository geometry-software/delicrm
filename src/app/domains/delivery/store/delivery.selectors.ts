...
const storeFeatureKey: string = DeliveryConstants.storeFeatureKey
const paginationTitle: string = DeliveryConstants.paginationTitle
const paginationSize: Array<number> = DeliveryConstants.paginationSize
