...
export abstract class OrderConstants {
  ...
  static readonly paginationTitle = 'ORDERS.LIST.FOOTER-TITLE'
  static readonly labelDining = 'ORDERS.LIST.TAB.DINING'
  static readonly labelDelivery = 'ORDERS.LIST.TAB.DELIVERY'
  static readonly labelClosed = 'ORDERS.LIST.TAB.CLOSED'
